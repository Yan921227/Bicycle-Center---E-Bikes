...
input_path = "output_fft_segments\\右轉\\fft_右轉.csv"  # ← 輸入檔案名稱
...
# 最終輸出檔案位置
output_path = os.path.join(output_folder, "fft_右轉_特徵.csv")
...
# === 步驟 2：智慧特徵擷取器定義 ===
def smart_fft_feature_selector(df, low_freq_max=23.50, mid_freq_max=78.50, high_freq_min=133.50, top_n=3):
    features = []
